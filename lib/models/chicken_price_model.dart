class ChickenPriceModel {
  ...
  ChickenPriceModel.fromJson(dynamic json) {
    apiCode = json['api_code'];
    errorCount = json['error_count'];
    if (json['error_message'] != null) {
      errorMessage = [];
      json['error_message'].forEach((v) {
        errorMessage?.add(ChickenPriceModel.fromJson(v));
      });
    }
...
class ApiResponse {
  ApiResponse({
    this.chickensaleId,
    this.chickensaleUuid,
    this.chickensaleQty,
    this.farmLiveBirdCost,
    this.retailLiveBirdCost,
    this.dressedWithSkinCost,
    this.dressedSkinLessCost,
    this.isSpecialSale,
    this.chickensaleEffectFrom,
    this.chickensaleEffectTo,
    this.chickensaleComment,
    this.chickensaleStatus,
    this.chickensaleCreatedon,
    this.chickensaleUpdatedon,
    this.birdBreedInfo,
    this.userBasicInfo,
  ...
  ApiResponse.fromJson(dynamic json) {
    chickensaleId = json['chickensale_id'];
    chickensaleUuid = json['chickensale_uuid'];
    chickensaleQty = json['chickensale_qty'];
    farmLiveBirdCost = json['farm_live_bird_cost'];
    retailLiveBirdCost = json['retail_live_bird_cost'];
    dressedWithSkinCost = json['dressed_with_skin_cost'];
    dressedSkinLessCost = json['dressed_skin_less_cost'];
    isSpecialSale = json['is_special_sale'];
    chickensaleEffectFrom = json['chickensale_effect_from'];
    chickensaleEffectTo = json['chickensale_effect_to'];
    chickensaleComment = json['chickensale_comment'];
    chickensaleStatus = json['chickensale_status'];
    chickensaleCreatedon = json['chickensale_createdon'];
    chickensaleUpdatedon = json['chickensale_updatedon'];
  ...
  String? chickensaleId;
  String? chickensaleUuid;
  String? chickensaleQty;
  String? farmLiveBirdCost;
  String? retailLiveBirdCost;
  String? dressedWithSkinCost;
  String? dressedSkinLessCost;
  String? isSpecialSale;
  String? chickensaleEffectFrom;
  String? chickensaleEffectTo;
  String? chickensaleComment;
  String? chickensaleStatus;
  String? chickensaleCreatedon;
  String? chickensaleUpdatedon;
  ...
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    map['chickensale_id'] = chickensaleId;
    map['chickensale_uuid'] = chickensaleUuid;
    map['chickensale_qty'] = chickensaleQty;
    map['farm_live_bird_cost'] = farmLiveBirdCost;
    map['retail_live_bird_cost'] = retailLiveBirdCost;
    map['dressed_with_skin_cost'] = dressedWithSkinCost;
    map['dressed_skin_less_cost'] = dressedSkinLessCost;
    map['is_special_sale'] = isSpecialSale;
    map['chickensale_effect_from'] = chickensaleEffectFrom;
    map['chickensale_effect_to'] = chickensaleEffectTo;
    map['chickensale_comment'] = chickensaleComment;
    map['chickensale_status'] = chickensaleStatus;
    map['chickensale_createdon'] = chickensaleCreatedon;
    map['chickensale_updatedon'] = chickensaleUpdatedon;
